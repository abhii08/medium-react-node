...
import type { signupInput } from "@abhinav08/medium-blogging";
        ...
        <div className="flex justify-center">
          <div>
            ...
            <div className="pt-8">
                ...
                <LabelledInput label="Username" placeholder="abhinav@gmail.com" onChange={(e) => {
                    setPostInputs({
                        ...postInputs,
...
function LabelledInput({label, placeholder, onChange, type }:LabbledInputType) {
    return <div>
